...
export const Stats = () => {
  const mockData = [{title: '12345', text :'Lorem ipsum dolor'},{title: '12345', text :'Lorem ipsum dolor'},{title: '12345', text :'Lorem ipsum dolor'}]
  return (
    <div className={styles.stats}>
      <h3 className={styles.title}>Roadmap stats</h3>
        {mockData.map(el => {
          ...
          return <div className={styles.stats_elem} key={nanoid()}>
